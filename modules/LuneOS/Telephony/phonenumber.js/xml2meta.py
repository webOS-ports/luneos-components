# Python script to generate PhoneNumberMetaData.js from Google's PhoneNumberMetadata.xml
#
# Latest version of XML file can be retrieved here:
#   https://raw.githubusercontent.com/googlei18n/libphonenumber/master/resources/PhoneNumberMetadata.xml
# To generate the .js version, start this script with:
#   python xml2meta.py PhoneNumberMetadata.xml > PhoneNumberMetadata.js
