...
Item {
    ...
    readonly property string _template: "Mozilla/5.0 (LuneOS, like webOS/3.0.5; %1) AppleWebKit/%2 (KHTML, like Gecko) QtWebEngine/5.11.3 Chrome/65.0.3325.230 Safari/%2"
